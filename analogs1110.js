<div id="myCompany">
<span id="company"><h4>Компании</h4></span>
<table>
<tbody>
<tr><td><strong>№</strong></td><td><strong>Наименование</strong></td><td><strong>ИНН / КПП</strong></td><td><strong>Адрес</strong></td><td></td></tr>
<tr><td>1</td><td>{this.props.arrayMyCompanies["clients"][0].name}</td><td>{this.props.arrayMyCompanies["clients"][0].inn} / {this.props.arrayMyCompanies["clients"][0].kpp}</td><td>{this.props.arrayMyCompanies["clients"][0].address}</td><td></td></tr>
</tbody>
</table>
</div>
...
{/*  <div className="Analogs">
      <table id="bestPrice"  border="1" cellSpacing="0" cellPadding="4">
         ...
         <tr>
          ...
          </svg> 1-3 дня</th><th>7 090 <span className="rub">Р</span> </th><th><button id="inGarbage" onClick={(e)=>{this.clickBasket(e);}}>В корзину</button></th>
         </tr>
         <tr>
          <th>&#9632;</th><th id="fixedName">VAG 5E0807217 Облицовка бампера</th>
          <th id="quantity"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="11" viewBox="0 0 19 11">
